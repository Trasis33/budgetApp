...
import type { BudgetWithSpending, Expense } from '../../types';
...
// Map scope type to API scope
const mapScopeToApi = (scope: string): 'ours' | 'mine' | 'partner' | 'all' => {
  if (scope === 'shared') return 'ours';
