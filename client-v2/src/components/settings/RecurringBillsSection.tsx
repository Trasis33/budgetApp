...
import { AlertCircle, CalendarIcon, CreditCard, RefreshCw } from 'lucide-react';
...
export function RecurringBillsSection() {
  ...
  const billTemplates = templates.filter((t) => t.bill_managed);
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        {!loading && billTemplates.length === 0 && !showNewForm && (
